loadstring(game:HttpGet("https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source"))() -- Infinite Yeild
wait(0.1)
loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Kosmos-Studios/Scripts/main/ChatTranslate.lua"))() -- Chat Translate
wait(0.1) -- After Is Emoji Script
-- // Notes:
